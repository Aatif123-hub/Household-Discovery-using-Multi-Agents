direct_matcher = """Identify records where the full names are the same or have minor spelling variations.
...
indirect_matcher = """Identify records where one record matches two others via different attributes (e.g., name and address).
...
household_matcher = """Identify records with different names but the same address.
...
household_moves = """Identify groups of records where the same individuals (by name) are associated with more than one address.
